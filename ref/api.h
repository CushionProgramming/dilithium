...
int pqcrystals_dilithium2_ref_derive(uint8_t *pk, uint8_t *sk);
...
int pqcrystals_dilithium3_ref_derive(uint8_t *pk, uint8_t *sk);
...
int pqcrystals_dilithium5_ref_derive(uint8_t *pk, uint8_t *sk);
